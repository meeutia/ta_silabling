import { AlertCircle, FileText, Loader2, Send, X } from 'lucide-react';
import {
  formatDate,
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-xs text-gray-500">
                        Sampel yang dipilih di sini akan menjadi satu LHU. Urutan sampel pada LHU ditentukan otomatis oleh sistem berdasarkan nomor sampel.
                      </p>
                    </div>
              ...
              <div>
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    {detailMode === 'finalisasi' && displayDetails.length > 1 && (
                ...
                {loadingPreview ? (
                  ...
                  <DetailLhuTable
                    ...
                    draggable={detailMode === 'finalisasi' && displayDetails.length > 1}
                    onMoveRow={onMoveDetailRow}
                  />
                )}
              </div>

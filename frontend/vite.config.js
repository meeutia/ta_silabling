      ...
      rollupOptions: {
        output: {
          manualChunks(id) {
            ...
            if (id.includes('/src/components/admin/')) return 'role-admin';
            if (id.includes('/src/components/pelanggan/')) return 'role-pelanggan';
            if (id.includes('/src/components/kasi/')) return 'role-kasi';

const { Lka, LkaHasil, } = require('../../models/Associations');
const { getPlain, pickObject, } = require('./assignment-object.helper');
class AssignmentLkaResultService {
getLkaResultRowsForSample = async (noSampel, transaction = null) => {
...
module.exports = new AssignmentLkaResultService();
module.exports.AssignmentLkaResultService = AssignmentLkaResultService;

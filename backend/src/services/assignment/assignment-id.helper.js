...
const { Penugasan, PenugasanDetail, Lka, LkaRevisi } = require('../../models/Associations');
...
module.exports = new AssignmentIdHelper();
module.exports.AssignmentIdHelper = AssignmentIdHelper;

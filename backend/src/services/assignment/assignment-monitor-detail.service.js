...
async function resolvePenugasanId(idPenugasan, options = {}) {
  const fallbackDetailId = String(
    options.idPenugasanDetail ||
...
async function getAssignmentDetailsByPenugasan(idPenugasan, options = {}) {
  const resolvedIdPenugasan = await resolvePenugasanId(idPenugasan, options);

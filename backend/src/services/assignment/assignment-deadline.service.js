...
const { Penugasan, PenugasanDetail, } = require('../../models/Associations');
...
module.exports = new AssignmentDeadlineService();
module.exports.AssignmentDeadlineService = AssignmentDeadlineService;

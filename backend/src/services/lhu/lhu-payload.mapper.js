...
class LhuPayloadMapper {
isEditableByQcStatus = (status) => {
    ...
    mapSamplePayload = (sampleInfo = {}) => {
        const standarLabel = this.buildStandarLabel(sampleInfo);
        return {
    ...
    mapPelangganPayload = (sampleInfo = {}) => {
        return {
    ...
    getPktBmHeaderById = async (idPktBm) => {
        if (!idPktBm)
            return {};
    ...
    mapLhuHeaderPayload = (lhu = {}, sample = {}, pktBm = {}, names = {}) => {
        const standarLabel = buildAcuanBmSnapshot(pktBm) || this.buildStandarLabel(sample);
        return {
            ...lhu,
...
module.exports = new LhuPayloadMapper();
module.exports.LhuPayloadMapper = LhuPayloadMapper;

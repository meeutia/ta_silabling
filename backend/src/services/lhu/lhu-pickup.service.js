...
async function moveRequestToWaitingLhuPickup({ idRegistrasi, actorNik, transaction }) {
  ...
  if (fpplInstance.status_fppl === RequestStatus.WAITING_LHU_PICKUP) return;
...
async function schedulePickup({ idRegistrasi, tanggalPengambilan, jamPengambilan, catatan }, currentNik) {
  ...
  const result = await sequelize.transaction(async (transaction) => {
    ...
    await moveRequestToWaitingLhuPickup({

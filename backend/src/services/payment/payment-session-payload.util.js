...
class PaymentSessionPayloadUtil {
buildPaymentGatewayPayload = (payment) => {
    ...
    buildXenditPaymentSessionPayload = ({ requestJson, requestId, invoice, payment, amount, referenceId, paymentMethod = null }) => {
...
module.exports = new PaymentSessionPayloadUtil();
module.exports.PaymentSessionPayloadUtil = PaymentSessionPayloadUtil;

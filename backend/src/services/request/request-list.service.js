...
const { Fppl, FpplSampel, FpplParameterMetode, Pelanggan, JenisSampel, RegBm, ParameterMetode, Parameter, Metode, TarifPengambilan, JadwalSampel, PktBm, Pegawai, User, Sampel, SampelParameter, Penugasan, PenugasanDetail, PenugasanItem, Lka, LkaHasil, Lhu, JadwalPengambilanLhu, PengajuanPerubahanJadwal, } = require('../../models/Associations');
...
listRequests = async (userNik, role, queryStatus) => {
        let whereClause = {};
...
module.exports = new RequestListService();
module.exports.RequestListService = RequestListService;
